...
In this name,
- `{pv, wind}` represents the type of renewable energy power: solar or wind;
- `{True, False}` represents whether have conditions;
- `{G, D}` represents generator/discriminator.

To change the hyperparameters, please check `train.py` for training parameters and `gan.py` for model structures.
